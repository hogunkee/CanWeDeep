...
parser.add_argument('--learning_rate_D', type=float, default=1e-3, help='learning rate of Discriminator')
parser.add_argument('--learning_rate_G', type=float, default=1e-1, help='learning rate of Generator')

parser.add_argument('--test_size', type=int, default=10, help='num of test images')
parser.add_argument('--print_step', type=int, default=5, help='print steps')
