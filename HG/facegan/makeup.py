...
parser.add_argument("--input_dir", default='data/new_resize', help="path to folder containing images")
...
### Generator ###
def create_generator(gen_inputs, out_channels):
    layers = []
    ...
    layer_specs = [
        ...
        (3, 0.0),  # decoder_1: [batch, 32, 32, ngf*2*2] => [batch, 64, 64, 3]
    ]
