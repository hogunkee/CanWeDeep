...
parser.add_argument("--input_dir_A", default='data/before', help="path to folder containing images")
parser.add_argument("--input_dir_B", default='data/after', help="path to folder containing images")
...
parser.add_argument("--display_freq", type=int, default=10000, help="write current training images every display_freq steps")
...
def load_examples():
    a_images, paths, count = load_images(a.input_dir_A)
    b_images, _, __ = load_images(a.input_dir_B)
...
def load_images(input_dir):
    ...
    with tf.name_scope(input_dir):
        input_images = transform(a_images)

    return input_images, paths, len(input_paths)
