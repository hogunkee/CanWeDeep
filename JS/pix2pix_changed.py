...
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    layer_specs = [
        ...
        a.ngf * 16, # encoder_5: [batch, 4, 4, ngf * 8] => [batch, 2, 2, ngf * 16]
        a.ngf * 16, # encoder_6: [batch, 2, 2, ngf * 16] => [batch, 1, 1, ngf * 16]
    ]
    ...
    layer_specs = [
	#cannot understand num_channel * 2
	#do not believe batch size. it's 1 to 32 
...
def create_model(inputs, targets):
    ...
    with tf.name_scope("real_discriminator"):
        with tf.variable_scope("discriminator"):
            # 2x [batch, height, width, channels] => [batch, 6, 6, 1]
